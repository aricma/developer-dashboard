...
from business_logic.models.story_points import EstimatedStoryPoints, StoryPoints
...
test_cases: List[ForecastBurnDownForTaskTestCase] = [
    ForecastBurnDownForTaskTestCase(
        ...
        expected_forecast={TODAY.to_string(): EstimatedStoryPoints(0)},
    ),
    ForecastBurnDownForTaskTestCase(
    ...
    ForecastBurnDownForTaskTestCase(
        ...
        expected_forecast={
            TODAY.to_string(): EstimatedStoryPoints(26),
            TOMORROW.to_string(): EstimatedStoryPoints(20),
            Date(2020, 1, 3).to_string(): EstimatedStoryPoints(14),
            Date(2020, 1, 4).to_string(): EstimatedStoryPoints(8),
            Date(2020, 1, 5).to_string(): EstimatedStoryPoints(2),
            Date(2020, 1, 6).to_string(): EstimatedStoryPoints(0),
        },
    ),
    ForecastBurnDownForTaskTestCase(
        ...
        developer_velocity_as_story_points_per_day=6,
        expected_forecast={
            THREE_DAYS_AGO.to_string(): StoryPoints(26),
            TWO_DAYS_AGO.to_string(): StoryPoints(20),
            YESTERDAY.to_string(): StoryPoints(14),
            TODAY.to_string(): EstimatedStoryPoints(8),
            TOMORROW.to_string(): EstimatedStoryPoints(2),
            Date(2020, 1, 3).to_string(): EstimatedStoryPoints(0),
        },
    ),
]
...
def test__forecast_burn_down_for_task_with_weekend_skipper() -> None:
    test_case = ForecastBurnDownForTaskTestCase(
        ...
        expected_forecast={
            ...
            TOMORROW.to_string(): EstimatedStoryPoints(20),
            Date(2020, 1, 3).to_string(): EstimatedStoryPoints(14),
            Date(2020, 1, 6).to_string(): EstimatedStoryPoints(8),
            Date(2020, 1, 7).to_string(): EstimatedStoryPoints(2),
            Date(2020, 1, 8).to_string(): EstimatedStoryPoints(0),
        },
    )
    brun_down_fore_caster = BurnDownForecaster(
